import{j as e}from"./jsx-runtime-HZcHCjrf.js";import{D as i}from"./DeleteButton-BVi4B0K3.js";import{C as c,b as m}from"./Card-LEuwn5qe.js";import{L as n}from"./LinkButton-oRvfrqLO.js";import{f as o}from"./date-w36NhWG5.js";import"./iframe-ZqPSSjEE.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-DDUONLuK.js";import"./index-Cnwyuldv.js";import"./link-DOiUunGb.js";function d({blog:t}){return e.jsx(c,{children:e.jsxs(m,{children:[e.jsx("h1",{className:"text-3xl font-bold text-gray-900 mb-4",children:t.title}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-gray-500 mb-6 pb-6 border-b border-gray-200",children:[e.jsxs("div",{children:[e.jsx("span",{className:"font-medium",children:"作成:"})," ",o(t.createdAt)]}),e.jsxs("div",{children:[e.jsx("span",{className:"font-medium",children:"更新:"})," ",o(t.updatedAt)]})]}),e.jsx("div",{className:"prose max-w-none mb-8",children:e.jsx("p",{className:"whitespace-pre-wrap text-gray-700",children:t.content})}),e.jsxs("div",{className:"flex gap-4 pt-6 border-t border-gray-200",children:[e.jsx(n,{href:`/blogs/${t.id}/edit`,variant:"primary",children:"編集"}),e.jsx(i,{blogId:t.id}),e.jsx(n,{href:"/blogs",variant:"secondary",children:"一覧に戻る"})]})]})})}d.__docgenInfo={description:"",methods:[],displayName:"BlogDetail",props:{blog:{required:!0,tsType:{name:"Blog"},description:""}}};const T={title:"Features/Blog/BlogDetail",component:d,args:{blog:{id:"1",title:"Next.js App Routerの完全ガイド",content:`Next.js 13で導入されたApp Routerは、従来のPages Routerに代わる新しいルーティングシステムです。
...
}`,...s.parameters?.docs?.source}}};const y=["Default","ShortContent","LongTitle"];export{r as Default,s as LongTitle,a as ShortContent,y as __namedExportsOrder,T as default};
