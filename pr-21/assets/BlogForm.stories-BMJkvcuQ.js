import{j as e}from"./jsx-runtime-1LN5D7Kx.js";import{B as p}from"./Button-CG5yQ9Qt.js";import{C as l,b as c}from"./Card-B1bPBOFI.js";import{I as f}from"./Input-DpHUM5Q_.js";import{T as g}from"./Textarea-tqCcaRb_.js";import"./iframe-CBE4tfgm.js";import"./preload-helper-PPVm8Dsz.js";function o({formAction:s,defaultTitle:i,defaultContent:m,submitLabel:u,isPending:d}){return e.jsx(l,{children:e.jsx(c,{children:e.jsxs("form",{action:s,className:"space-y-4",children:[e.jsx(f,{name:"title",label:"タイトル",placeholder:"ブログのタイトルを入力",required:!0,defaultValue:i}),e.jsx(g,{name:"content",label:"本文",placeholder:"ブログの本文を入力",rows:10,required:!0,defaultValue:m}),e.jsx("div",{className:"flex gap-4",children:e.jsx(p,{type:"submit",variant:"primary",disabled:d,children:u})})]})})})}o.__docgenInfo={description:"",methods:[],displayName:"BlogForm",props:{formAction:{required:!0,tsType:{name:"signature",type:"function",raw:"(formData: FormData) => void",signature:{arguments:[{type:{name:"FormData"},name:"formData"}],return:{name:"void"}}},description:""},defaultTitle:{required:!1,tsType:{name:"string"},description:""},defaultContent:{required:!1,tsType:{name:"string"},description:""},submitLabel:{required:!0,tsType:{name:"string"},description:""},isPending:{required:!1,tsType:{name:"boolean"},description:""}}};const{action:b}=__STORYBOOK_MODULE_ACTIONS__,_={title:"Features/Blog/BlogFormUI",component:o,args:{formAction:s=>{b("form-submit")(Object.fromEntries(s))},submitLabel:"投稿"}},r={name:"新規作成"},t={name:"編集（既存データあり）",args:{submitLabel:"更新",defaultTitle:"既存のブログタイトル",defaultContent:"これは既存のブログ記事の本文です。編集モードでは、このようにデフォルト値が入力されています。"}},n={name:"編集（長い本文）",args:{submitLabel:"更新",defaultTitle:"Next.js App Routerの完全ガイド",defaultContent:`Next.js 13で導入されたApp Routerは、従来のPages Routerに代わる新しいルーティングシステムです。
